...
#ifndef ARM_POS_INTERFACES__MSG__DETAIL__ARM_END_MOTION__TRAITS_HPP_
#define ARM_POS_INTERFACES__MSG__DETAIL__ARM_END_MOTION__TRAITS_HPP_
...
inline void to_yaml(
  const arm_pos_interfaces::msg::ArmEndMotion & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const arm_pos_interfaces::msg::ArmEndMotion & msg)
{
  return arm_pos_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<arm_pos_interfaces::msg::ArmEndMotion>()
{
  return "arm_pos_interfaces::msg::ArmEndMotion";
}

template<>
inline const char * name<arm_pos_interfaces::msg::ArmEndMotion>()
{
  return "arm_pos_interfaces/msg/ArmEndMotion";
}

template<>
struct has_fixed_size<arm_pos_interfaces::msg::ArmEndMotion>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<arm_pos_interfaces::msg::ArmEndMotion>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<arm_pos_interfaces::msg::ArmEndMotion>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ARM_POS_INTERFACES__MSG__DETAIL__ARM_END_MOTION__TRAITS_HPP_
