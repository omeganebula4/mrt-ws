...
#include "arm_pos_interfaces/msg/detail/encoder_arm__rosidl_typesupport_fastrtps_c.h"
...
#include "arm_pos_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _EncoderArm__ros_msg_type = arm_pos_interfaces__msg__EncoderArm;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_pos_interfaces
size_t get_serialized_size_arm_pos_interfaces__msg__EncoderArm(
  const void * untyped_ros_message,
...
static uint32_t _EncoderArm__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_pos_interfaces__msg__EncoderArm(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_pos_interfaces
size_t max_serialized_size_arm_pos_interfaces__msg__EncoderArm(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_pos_interfaces__msg__EncoderArm;
    is_plain =
      (
...
static size_t _EncoderArm__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_pos_interfaces__msg__EncoderArm(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_pos_interfaces, msg, EncoderArm)() {
