...
bool aruco_detection_interfaces__msg__point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_detection_interfaces.msg._point.Point", full_classname_dest, 43) == 0);
  }
  aruco_detection_interfaces__msg__Point * ros_message = _ros_message;
  {  // coords
...
PyObject * aruco_detection_interfaces__msg__point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_detection_interfaces.msg._point");
