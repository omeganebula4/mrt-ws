...
static const _ProcessImage_Request_type_support_symbol_names_t _ProcessImage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_detection_interfaces, srv, ProcessImage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aruco_detection_interfaces, srv, ProcessImage_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aruco_detection_interfaces, srv, ProcessImage_Request)() {
  return &::aruco_detection_interfaces::srv::rosidl_typesupport_c::ProcessImage_Request_message_type_support_handle;
}
...
static const _ProcessImage_Response_type_support_symbol_names_t _ProcessImage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_detection_interfaces, srv, ProcessImage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aruco_detection_interfaces, srv, ProcessImage_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aruco_detection_interfaces, srv, ProcessImage_Response)() {
  return &::aruco_detection_interfaces::srv::rosidl_typesupport_c::ProcessImage_Response_message_type_support_handle;
}
...
static const _ProcessImage_type_support_symbol_names_t _ProcessImage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_detection_interfaces, srv, ProcessImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aruco_detection_interfaces, srv, ProcessImage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aruco_detection_interfaces, srv, ProcessImage)() {
  return &::aruco_detection_interfaces::srv::rosidl_typesupport_c::ProcessImage_service_type_support_handle;
}
