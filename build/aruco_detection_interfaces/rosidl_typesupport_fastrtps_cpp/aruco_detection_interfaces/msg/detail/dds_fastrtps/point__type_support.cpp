...
#include "aruco_detection_interfaces/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aruco_detection_interfaces::msg::Point & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_detection_interfaces::msg::Point & ros_message)
{
  // Member: coords
  {
    cdr >> ros_message.coords;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 2;
    size_t item_size = sizeof(ros_message.coords[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_detection_interfaces::msg::Point;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_detection_interfaces::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_detection_interfaces::msg::Point *>(
    untyped_ros_message);
...
{
  return &aruco_detection_interfaces::msg::typesupport_fastrtps_cpp::_Point__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_detection_interfaces, msg, Point)() {
  return &aruco_detection_interfaces::msg::typesupport_fastrtps_cpp::_Point__handle;
}
