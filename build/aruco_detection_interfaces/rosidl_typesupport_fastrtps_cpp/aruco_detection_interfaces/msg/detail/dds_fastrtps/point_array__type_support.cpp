...
#include "aruco_detection_interfaces/msg/detail/point_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const aruco_detection_interfaces::msg::Point &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  aruco_detection_interfaces::msg::Point &);
...
cdr_serialize(
  const aruco_detection_interfaces::msg::PointArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_detection_interfaces::msg::PointArray & ros_message)
{
  // Member: rowpoints
  {
    for (size_t i = 0; i < 4; i++) {
  ...
  // Member: rowpoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.rowpoints[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: rowpoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        aruco_detection_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Point(
  ...
  if (is_plain) {
    ...
    using DataType = aruco_detection_interfaces::msg::PointArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_detection_interfaces::msg::PointArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_detection_interfaces::msg::PointArray *>(
    untyped_ros_message);
...
{
  return &aruco_detection_interfaces::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_detection_interfaces, msg, PointArray)() {
  return &aruco_detection_interfaces::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
