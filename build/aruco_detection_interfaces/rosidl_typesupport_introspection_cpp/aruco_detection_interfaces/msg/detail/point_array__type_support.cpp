...
{
  new (message_memory) aruco_detection_interfaces::msg::PointArray(_init);
}

void PointArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aruco_detection_interfaces::msg::PointArray *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<aruco_detection_interfaces::msg::Point, 4> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<aruco_detection_interfaces::msg::Point, 4> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const aruco_detection_interfaces::msg::Point *>(
    get_const_function__PointArray__rowpoints(untyped_member, index));
  auto & value = *reinterpret_cast<aruco_detection_interfaces::msg::Point *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<aruco_detection_interfaces::msg::Point *>(
    get_function__PointArray__rowpoints(untyped_member, index));
  const auto & value = *reinterpret_cast<const aruco_detection_interfaces::msg::Point *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointArray_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<aruco_detection_interfaces::msg::Point>(),  // members of sub message
    true,  // is array
    4,  // array size
    false,  // is upper bound
    offsetof(aruco_detection_interfaces::msg::PointArray, rowpoints),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PointArray_message_members = {
  ...
  1,  // number of fields
  sizeof(aruco_detection_interfaces::msg::PointArray),
...
get_message_type_support_handle<aruco_detection_interfaces::msg::PointArray>()
{
  return &::aruco_detection_interfaces::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_detection_interfaces, msg, PointArray)() {
  return &::aruco_detection_interfaces::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
