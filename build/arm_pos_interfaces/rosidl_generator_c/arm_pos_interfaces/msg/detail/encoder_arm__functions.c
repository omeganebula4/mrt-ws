...
arm_pos_interfaces__msg__EncoderArm__init(arm_pos_interfaces__msg__EncoderArm * msg)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->arm_node0, 0)) {
    arm_pos_interfaces__msg__EncoderArm__fini(msg);
    return false;
  }
  // arm_node1
...
arm_pos_interfaces__msg__EncoderArm__create()
{
  ...
  arm_pos_interfaces__msg__EncoderArm * msg = (arm_pos_interfaces__msg__EncoderArm *)allocator.allocate(sizeof(arm_pos_interfaces__msg__EncoderArm), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(arm_pos_interfaces__msg__EncoderArm));
  bool success = arm_pos_interfaces__msg__EncoderArm__init(msg);
  if (!success) {
...
arm_pos_interfaces__msg__EncoderArm__Sequence__init(arm_pos_interfaces__msg__EncoderArm__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_pos_interfaces__msg__EncoderArm * data = NULL;

  if (size) {
    data = (arm_pos_interfaces__msg__EncoderArm *)allocator.zero_allocate(size, sizeof(arm_pos_interfaces__msg__EncoderArm), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = arm_pos_interfaces__msg__EncoderArm__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        arm_pos_interfaces__msg__EncoderArm__fini(&data[i - 1]);
      }
...
arm_pos_interfaces__msg__EncoderArm__Sequence__fini(arm_pos_interfaces__msg__EncoderArm__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      arm_pos_interfaces__msg__EncoderArm__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_pos_interfaces__msg__EncoderArm__Sequence * array = (arm_pos_interfaces__msg__EncoderArm__Sequence *)allocator.allocate(sizeof(arm_pos_interfaces__msg__EncoderArm__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = arm_pos_interfaces__msg__EncoderArm__Sequence__init(array, size);
  if (!success) {
...
arm_pos_interfaces__msg__EncoderArm__Sequence__destroy(arm_pos_interfaces__msg__EncoderArm__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    arm_pos_interfaces__msg__EncoderArm__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
arm_pos_interfaces__msg__EncoderArm__Sequence__are_equal(const arm_pos_interfaces__msg__EncoderArm__Sequence * lhs, const arm_pos_interfaces__msg__EncoderArm__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!arm_pos_interfaces__msg__EncoderArm__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  arm_pos_interfaces__msg__EncoderArm__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(arm_pos_interfaces__msg__EncoderArm);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    arm_pos_interfaces__msg__EncoderArm * data =
      (arm_pos_interfaces__msg__EncoderArm *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!arm_pos_interfaces__msg__EncoderArm__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          arm_pos_interfaces__msg__EncoderArm__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!arm_pos_interfaces__msg__EncoderArm__copy(
