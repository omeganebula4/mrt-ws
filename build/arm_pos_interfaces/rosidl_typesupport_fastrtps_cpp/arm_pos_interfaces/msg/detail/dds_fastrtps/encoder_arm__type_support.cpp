...
#include "arm_pos_interfaces/msg/detail/encoder_arm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_pos_interfaces::msg::EncoderArm & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_pos_interfaces::msg::EncoderArm & ros_message)
{
  // Member: arm_node0
  {
    cdr >> ros_message.arm_node0;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_pos_interfaces::msg::EncoderArm;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_pos_interfaces::msg::EncoderArm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_pos_interfaces::msg::EncoderArm *>(
    untyped_ros_message);
...
{
  return &arm_pos_interfaces::msg::typesupport_fastrtps_cpp::_EncoderArm__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_pos_interfaces, msg, EncoderArm)() {
  return &arm_pos_interfaces::msg::typesupport_fastrtps_cpp::_EncoderArm__handle;
}
