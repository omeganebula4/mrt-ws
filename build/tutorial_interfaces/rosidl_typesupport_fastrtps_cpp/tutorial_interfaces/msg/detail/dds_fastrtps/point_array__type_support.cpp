...
#include "tutorial_interfaces/msg/detail/point_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tutorial_interfaces::msg::Point &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  tutorial_interfaces::msg::Point &);
...
cdr_serialize(
  const tutorial_interfaces::msg::PointArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::PointArray & ros_message)
{
  // Member: rowpoints
  {
    for (size_t i = 0; i < 4; i++) {
  ...
  size_t current_alignment)
{
  ...
  // Member: rowpoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tutorial_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Point(
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces::msg::PointArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::PointArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::PointArray *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, PointArray)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
