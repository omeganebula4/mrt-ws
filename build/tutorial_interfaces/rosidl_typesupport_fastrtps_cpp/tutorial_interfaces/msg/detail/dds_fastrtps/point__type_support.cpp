...
#include "tutorial_interfaces/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::Point & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::Point & ros_message)
{
  // Member: coords
  {
    cdr >> ros_message.coords;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces::msg::Point;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::Point *>(
    untyped_ros_message);
...
get_message_type_support_handle<tutorial_interfaces::msg::Point>()
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_Point__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, Point)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_Point__handle;
}
