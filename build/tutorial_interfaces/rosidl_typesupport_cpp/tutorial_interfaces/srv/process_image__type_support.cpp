...
static const _ProcessImage_Request_type_support_symbol_names_t _ProcessImage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, ProcessImage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, ProcessImage_Request)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::ProcessImage_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, ProcessImage_Request)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::ProcessImage_Request>();
}
...
static const _ProcessImage_Response_type_support_symbol_names_t _ProcessImage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, ProcessImage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, ProcessImage_Response)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::ProcessImage_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, ProcessImage_Response)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::ProcessImage_Response>();
}
...
static const _ProcessImage_type_support_symbol_names_t _ProcessImage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, ProcessImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, ProcessImage)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::ProcessImage_service_type_support_handle;
}
