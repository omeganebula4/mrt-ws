...
#include "all_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
#include "all_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // t, x, y, z
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // t, x, y, z

// forward declare type support functions


using _Waypoint__ros_msg_type = all_interfaces__msg__Waypoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: t
  {
    size_t size = ros_message->t.size;
    auto array_ptr = ros_message->t.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: t
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->t.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->t);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->t, size)) {
      fprintf(stderr, "failed to create array for field 't'");
      return false;
    }
    auto array_ptr = ros_message->t.data;
    cdr.deserializeArray(array_ptr, size);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_all_interfaces
size_t get_serialized_size_all_interfaces__msg__Waypoint(
  const void * untyped_ros_message,
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_all_interfaces__msg__Waypoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_all_interfaces
size_t max_serialized_size_all_interfaces__msg__Waypoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = all_interfaces__msg__Waypoint;
    is_plain =
      (
      offsetof(DataType, t) +
      last_member_size
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_all_interfaces__msg__Waypoint(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, all_interfaces, msg, Waypoint)() {
