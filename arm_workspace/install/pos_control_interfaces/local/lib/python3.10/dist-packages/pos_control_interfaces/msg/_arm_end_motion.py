...
class Metaclass_ArmEndMotion(type):
    """Metaclass of message 'ArmEndMotion'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'pos_control_interfaces.msg.ArmEndMotion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__arm_end_motion
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__arm_end_motion
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__arm_end_motion
            cls._TYPE_SUPPORT = module.type_support_msg__msg__arm_end_motion
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__arm_end_motion
...
class ArmEndMotion(metaclass=Metaclass_ArmEndMotion):
    """Message class 'ArmEndMotion'."""
