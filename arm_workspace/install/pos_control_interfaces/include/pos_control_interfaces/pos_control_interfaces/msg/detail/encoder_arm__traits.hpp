...
#ifndef POS_CONTROL_INTERFACES__MSG__DETAIL__ENCODER_ARM__TRAITS_HPP_
#define POS_CONTROL_INTERFACES__MSG__DETAIL__ENCODER_ARM__TRAITS_HPP_
...
inline void to_yaml(
  const pos_control_interfaces::msg::EncoderArm & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const pos_control_interfaces::msg::EncoderArm & msg)
{
  return pos_control_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<pos_control_interfaces::msg::EncoderArm>()
{
  return "pos_control_interfaces::msg::EncoderArm";
}

template<>
inline const char * name<pos_control_interfaces::msg::EncoderArm>()
{
  return "pos_control_interfaces/msg/EncoderArm";
}

template<>
struct has_fixed_size<pos_control_interfaces::msg::EncoderArm>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<pos_control_interfaces::msg::EncoderArm>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<pos_control_interfaces::msg::EncoderArm>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // POS_CONTROL_INTERFACES__MSG__DETAIL__ENCODER_ARM__TRAITS_HPP_
