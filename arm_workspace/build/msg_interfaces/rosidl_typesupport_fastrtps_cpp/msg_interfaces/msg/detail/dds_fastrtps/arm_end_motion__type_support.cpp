...
#include "msg_interfaces/msg/detail/arm_end_motion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_interfaces::msg::ArmEndMotion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interfaces::msg::ArmEndMotion & ros_message)
{
  // Member: direction
  {
    cdr >> ros_message.direction;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces::msg::ArmEndMotion;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interfaces::msg::ArmEndMotion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interfaces::msg::ArmEndMotion *>(
    untyped_ros_message);
...
{
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_ArmEndMotion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, msg, ArmEndMotion)() {
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_ArmEndMotion__handle;
}
