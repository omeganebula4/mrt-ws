...
#include "pos_control_interfaces/msg/detail/arm_end_motion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pos_control_interfaces::msg::ArmEndMotion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pos_control_interfaces::msg::ArmEndMotion & ros_message)
{
  // Member: direction
  {
    cdr >> ros_message.direction;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pos_control_interfaces::msg::ArmEndMotion;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pos_control_interfaces::msg::ArmEndMotion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pos_control_interfaces::msg::ArmEndMotion *>(
    untyped_ros_message);
...
{
  return &pos_control_interfaces::msg::typesupport_fastrtps_cpp::_ArmEndMotion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pos_control_interfaces, msg, ArmEndMotion)() {
  return &pos_control_interfaces::msg::typesupport_fastrtps_cpp::_ArmEndMotion__handle;
}
