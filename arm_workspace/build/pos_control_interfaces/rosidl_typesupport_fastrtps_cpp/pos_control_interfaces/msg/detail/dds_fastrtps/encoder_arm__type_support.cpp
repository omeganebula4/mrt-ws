...
#include "pos_control_interfaces/msg/detail/encoder_arm__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pos_control_interfaces::msg::EncoderArm;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pos_control_interfaces::msg::EncoderArm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pos_control_interfaces::msg::EncoderArm *>(
    untyped_ros_message);
...
{
  return &pos_control_interfaces::msg::typesupport_fastrtps_cpp::_EncoderArm__handle;
}
