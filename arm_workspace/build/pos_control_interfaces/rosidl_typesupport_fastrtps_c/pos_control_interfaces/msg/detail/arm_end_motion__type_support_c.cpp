...
#include "pos_control_interfaces/msg/detail/arm_end_motion__rosidl_typesupport_fastrtps_c.h"
...
using _ArmEndMotion__ros_msg_type = pos_control_interfaces__msg__ArmEndMotion;
...
size_t get_serialized_size_pos_control_interfaces__msg__ArmEndMotion(
  const void * untyped_ros_message,
...
static uint32_t _ArmEndMotion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pos_control_interfaces__msg__ArmEndMotion(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pos_control_interfaces
size_t max_serialized_size_pos_control_interfaces__msg__ArmEndMotion(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pos_control_interfaces__msg__ArmEndMotion;
    is_plain =
      (
...
static size_t _ArmEndMotion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pos_control_interfaces__msg__ArmEndMotion(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pos_control_interfaces, msg, ArmEndMotion)() {
