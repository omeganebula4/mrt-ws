...
{
  new (message_memory) pos_control_interfaces::msg::ArmEndMotion(_init);
}

void ArmEndMotion_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pos_control_interfaces::msg::ArmEndMotion *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmEndMotion_message_member_array[4] = {
  {
    ...
    offsetof(pos_control_interfaces::msg::ArmEndMotion, direction),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pos_control_interfaces::msg::ArmEndMotion, speed),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pos_control_interfaces::msg::ArmEndMotion, sys_check),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pos_control_interfaces::msg::ArmEndMotion, reset),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArmEndMotion_message_members = {
  ...
  4,  // number of fields
  sizeof(pos_control_interfaces::msg::ArmEndMotion),
...
{
  return &::pos_control_interfaces::msg::rosidl_typesupport_introspection_cpp::ArmEndMotion_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pos_control_interfaces, msg, ArmEndMotion)() {
  return &::pos_control_interfaces::msg::rosidl_typesupport_introspection_cpp::ArmEndMotion_message_type_support_handle;
}
