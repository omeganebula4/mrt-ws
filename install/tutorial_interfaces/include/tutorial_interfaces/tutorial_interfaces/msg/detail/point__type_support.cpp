...
{
  new (message_memory) tutorial_interfaces::msg::Point(_init);
}

void Point_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::msg::Point *>(message_memory);
  typed_message->~Point();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point_message_member_array[1] = {
  {
    ...
    offsetof(tutorial_interfaces::msg::Point, coords),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point_message_members = {
  ...
  "Point",  // message name
  1,  // number of fields
  sizeof(tutorial_interfaces::msg::Point),
...
{
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, msg, Point)() {
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
