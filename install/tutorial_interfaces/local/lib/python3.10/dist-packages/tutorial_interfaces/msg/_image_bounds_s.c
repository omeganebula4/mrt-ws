...
bool tutorial_interfaces__msg__point_array__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool tutorial_interfaces__msg__image_bounds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._image_bounds.ImageBounds", full_classname_dest, 49) == 0);
  }
  tutorial_interfaces__msg__ImageBounds * ros_message = _ros_message;
  {  // ids
  ...
  {  // bounds
    ...
    tutorial_interfaces__msg__PointArray * dest = ros_message->bounds;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!tutorial_interfaces__msg__point_array__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * tutorial_interfaces__msg__image_bounds__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._image_bounds");
  ...
  {  // bounds
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = tutorial_interfaces__msg__point_array__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
