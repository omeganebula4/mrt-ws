...
class Metaclass_ImageBounds(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tutorial_interfaces.msg import PointArray
...
class ImageBounds(metaclass=Metaclass_ImageBounds):
    ...
    _fields_and_field_types = {
        'ids': 'sequence<uint64>',
        'bounds': 'tutorial_interfaces/PointArray[1000]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('uint64')),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['tutorial_interfaces', 'msg'], 'PointArray'), 1000),  # noqa: E501
    )
